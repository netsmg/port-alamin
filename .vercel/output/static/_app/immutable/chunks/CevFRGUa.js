import{t as a,a as o}from"./DrjBu-Pq.js";import"./CeIxqNZp.js";import{$ as i}from"./CnMiI8Eq.js";const n={title:"The Art of Thinking Clearly (Part 2)",date:"2023-04-11T00:00:00.000Z",categories:["psychology"]},{title:d,date:c,categories:u}=n;var s=a(`<section><h2 id="why-we-prefer-a-wrong-map-to-no-map-at-all-availability-bias"><a href="#why-we-prefer-a-wrong-map-to-no-map-at-all-availability-bias">Why we prefer a wrong map to no map at all (Availability Bias)</a></h2><p>‘Smoking can’t be that bad for you: my grandfather smoked three packs of
...
available to our memory.</p><p>The availability bias says this: we create a picture of the world using the
...
more easily.</p><p>Thanks to the availability bias, we travel through life with an incorrect risk map
...
think dramatically, not quantitatively.</p><p>Doctors often fall victim to the availability bias. They have their favourite
...
or not it is ideal.</p><p>If something is repeated often enough, it gets stored at the forefront of our
minds. It doesn’t even have to be true.</p><p>The availability bias has an established seat at the corporate board’s table, too.
...
customer behaviour. They tend not to discuss what’s not on the agenda.</p><p>In addition, people prefer information that is easy to obtain, be it economic data or
recipes. They make decisions based on this information rather than on more
relevant but harder to obtain information – often with disastrous results.</p><p>It is as if you were in a foreign city without a map, and then pulled out one for your home town and simply used that.We prefer wrong information to no information. Thus, the availability bias has presented the banks with billions in losses.</p><p>Solution: Fend it off by spending time with people who think differently than you think – people whose experiences and expertise are different than yours. We require others’ input to overcome the availability bias.</p></section> <section><h2 id="why-no-pain-no-gain-should-set-alarm-bells-ringing"><a href="#why-no-pain-no-gain-should-set-alarm-bells-ringing">Why ‘No pain, No gain’ should set alarm bells ringing</a></h2><p>The It’ll-Get-Worse-Before-It-Gets-Better Fallacy</p><p>A few years ago, I was on vacation in Corsica and fell sick. The symptoms were
...
hotel room with the prescription in hand.</p><p>The pain grew worse and worse – just as the doctor had predicted. The doctor
...
the surgery.</p><p>I replied: ‘It all happened exactly as the doctor said, so I trusted him.’
...
all the tourist places in high season.’</p><p>Let’s take another example: a CEO is at his wits’ end. Sales are in the toilet, the
...
consultant.</p><p>A mere smokescreen, the It’ll-Get-Worse-Before-It-Gets-Better Fallacy is a
...
happy and the expert can attribute it to his prowess. Either way he wins.</p><p>Suppose you are president of a country, and have no idea how to run it. What
...
and severity of the period open.</p><p>The best evidence of this strategy’s success is Christianity: its literal followers
...
confirmation of the prophecy, and any improvement as a gift from God.</p><p>In conclusion: if someone says ‘It’ll get worse before it gets better,’ you should
...
are clear and verifiable. Look to these rather than to the heavens.</p></section> <section><h2 id="even-true-stories-are-fairytales"><a href="#even-true-stories-are-fairytales">EVEN TRUE STORIES ARE FAIRYTALES</a></h2><p>Story Bias</p><p>Life is a muddle, as intricate as a Gordian knot. Imagine that an invisible Martian
...
Super Bowl commercial from 2010, ‘Google Parisian Love’. Take a look at it on YouTube.</p><p>From our own life stories to global events, we shape everything into meaningful
...
and you’ll see that your life has not followed a straight arrow leading to today, but has been a series of unplanned unconnected events and experiences, as we’ll see in the next chapter.</p><p>Whenever you hear a story, ask yourself: who is the sender, what are his intentions and what did he hide under the rug? The omitted elements might not be of relevance. But then again, they might be even more relevant than the
...
a stroll on thin ice.</p></section> <section><h2 id="why-you-should-keep-a-diary-hindsight-bias"><a href="#why-you-should-keep-a-diary-hindsight-bias">Why you should keep a diary (Hindsight Bias)</a></h2><p>I came across the diaries of my great-uncle recently. In 1932, he emigrated from a
...
most likely of all scenarios. Why? Because we have fallen victim to the hindsight bias.</p><p>Let’s take a more recent example: in 2007, economic experts painted a rosy
...
reasons for the crash seem painfully obvious.</p><p>The hindsight bias is one of the most prevailing fallacies of all. We can aptly
...
the final vote.</p><p>Today, business journalists opine that Google’s dominance was
predestined, even though each of them would have snorted had such a prediction been made in 1998.</p><p>So why is the hindsight bias so perilous? Well, it makes us believe we are
...
another.’</p><p>Overcoming the hindsight bias is not easy. Studies have shown that people
who are aware of it fall for it just as much as everyone else. So, I’m very sorry, but
you’ve just wasted your time reading this chapter.</p><p>If you’re still with me, I have one final tip, this time from personal rather than
...
amazed at what a poor forecaster you are.</p><p>Don’t forget to read history too – not
...
better sense of just how unpredictable the world is.</p><p>Hindsight may provide temporary comfort to those overwhelmed by complexity, but as for providing
deeper revelations about how the world works, you’ll benefit by looking elsewhere.</p></section> <section><h2 id="why-you-systematically-overestimate-your-knowledge-and-abilities-overconfidence-effect"><a href="#why-you-systematically-overestimate-your-knowledge-and-abilities-overconfidence-effect">Why you systematically overestimate your knowledge and abilities (Overconfidence Effect)</a></h2><p>Overconfidence is a common human tendency where we often overestimate our knowledge and abilities, leading to inaccurate predictions and decisions. This phenomenon has been observed in various fields, including economics, relationships, and project management. Even experts can fall victim to overconfidence.</p><p>For example, surveys have shown that people tend to think they are above average in various areas, such as driving or teaching ability. Overconfidence is more prevalent in men and even self-proclaimed pessimists can still overrate themselves, albeit to a lesser extent. It’s important to be aware of this bias and approach predictions and plans with skepticism, favoring a more realistic and pessimistic outlook. As an example, Johann Sebastian Bach composed around 1127 surviving works, but may have composed even more that have been lost.</p></section> <section><h2 id="dont-take-news-anchors-seriously"><a href="#dont-take-news-anchors-seriously">Don’t take news anchors seriously</a></h2><p>Chauffeur Knowledge</p><p>After receiving the Nobel Prize for Physics in 1918, Max Planck went on tour
...
for you in Munich? You can sit in the front row and wear my chauffeur’s cap.</p><p>That’d give us both a bit of variety.’ Planck liked the idea, so that evening the
...
effort to understanding a topic.</p><p>The second type is chauffeur knowledge – knowledge from people who have learned to put on a show. Maybe they have a
great voice or good hair, but the knowledge they espouse is not their own. They reel off eloquent words as if reading from a script.</p><p>Unfortunately, it is increasingly difficult to separate true knowledge from
...
earn moderating panels about topics they barely fathom.</p><p>With journalists, it is more difficult. Some have acquired true knowledge. Often they are veteran reporters who have specialised for years in a clearly defined area. They make a serious effort to understand the complexity of a subject and to
...
for their patchy knowledge - snarky and self-satisfied in tone.</p><p>The same superficiality is present in business. The larger a company, the more
...
competence.’</p><p>In conclusion: be on the lookout for chauffeur knowledge. Do not confuse the company spokesperson, the ringmaster, the newscaster, the schmoozer, the verbiage vendor or the cliché generator with those who possess true knowledge. How do you recognise the difference There is a clear indicator: true experts recognise the limits of what they know and what they do not know. If they find themselves outside their circle of competence, they keep quiet or simply say, ‘I don’t know.’ This they utter unapologetically, even with a certain pride. From chauffeurs, we hear every line except this.</p></section> <section><h2 id="you-control-less-than-you-think"><a href="#you-control-less-than-you-think">You control less than you think</a></h2><p>Illusion of Control</p><p>Every day, shortly before nine o’clock, a man with a red hat stands in a square
...
good job, then.’</p><p>A friend with a broken leg was stuck in bed and asked me to pick up a lottery
...
looked at me blankly.</p><p>In casinos, most people throw the dice as hard as they can if they need a high
...
(vibrations, positive energy, karma?…?).</p><p>The illusion of control is the tendency to believe that we can influence
...
switches.</p><p>Or consider this example: an American researcher has been investigating
...
fraction encouraged these prisoners not to give up hope.</p><p>Crossing the street in Los Angeles is a tricky business, but luckily, at the press
...
are being pushed in all sorts of realms.</p><p>Central bankers and government officials employ placebo buttons masterfully.
...
uncontrollable system.</p><p>And you? Do you have everything under control? Probably less than you think.
...
that you can really influence.</p><p>For everything else: que sera, sera.</p></section> <section><h2 id="never-pay-your-lawyer-by-the-hour"><a href="#never-pay-your-lawyer-by-the-hour">Never pay your lawyer by the hour</a></h2><p>Incentive Super-Response Tendency</p><p>To control a rat infestation, French colonial rulers in Hanoi in the nineteenth
century passed a law: for every dead rat handed in to the authorities, the catcher
would receive a reward. Yes, many rats were destroyed, but many were also bred specially for this purpose.</p><p>In 1947, when the Dead Sea scrolls were discovered, archaeologists set a
...
than in growing the business.</p><p>These are examples of the incentive super-response tendency. Credited to
...
Nobody wants to be the loser CEO in his industry.</p><p>Do you want to influence the behaviour of people or organisations? You could
...
martyrs – with all the benefits that came with it. It was win-win.</p><p>Imagine for a moment that, instead of demanding enemies’ riches, warriors and
...
consultants, accountants and driving instructors?</p><p>=> My advice: forget hourly rates and always negotiate a fixed price in advance.</p><p>Be wary, too, of investment advisers endorsing particular financial products.
...
need a haircut.’</p><p>In conclusion: keep an eye out for the incentive super-response tendency. If a
...
the cases this way. What makes up the remaining 10%? Passion, idiocy, psychosis or malice.</p></section> <section><h2 id="the-dubious-efficacy-of-doctors-consultants-and-psychotherapists"><a href="#the-dubious-efficacy-of-doctors-consultants-and-psychotherapists">THE DUBIOUS EFFICACY OF DOCTORS, CONSULTANTS AND PSYCHOTHERAPISTS</a></h2><p>Regression to Mean
...
would recommend the therapist to everyone.</p><p>Another man, younger and with a respectable golf handicap of 12, gushed in a similar fashion about his golf instructor. Whenever he played miserably, he booked an hour with the pro, and lo and behold, in the next game he fared much better.</p><p>A third man, an investment adviser at a major bank, invented a sort of ‘rain
...
always improved afterward.</p><p>What links the three men is a fallacy: the regression-to-mean delusion.
...
market average – with or without the restroom dance.</p><p>Extreme performances are interspersed with less extreme ones. The most successful stock picks from the past three years are hardly going to be the most successful stocks in the coming three years. Knowing this, you can appreciate
...
media attention, but is to do with natural variations in performance.</p><p>Or, take the example of a division manager who wants to improve employee
...
rather than to natural regression to mean.</p><p>Ignoring regression to mean can have destructive consequences, such as
...
coincidentally – achieve the highest and lowest scores. Thus, the teacher concludes that reproach helps and praise hinders. A fallacy that keeps on giving.</p><p>In conclusion: when you hear stories such as: ‘I was sick, went to the doctor,
and got better a few days later’ or ‘the company had a bad year, so we got a
consultant in and now the results are back to normal’, look out for our old friend, the regression-to-mean error</p></section> <section><h2 id="never-judge-a-decision-by-its-outcome-outcome-bias"><a href="#never-judge-a-decision-by-its-outcome-outcome-bias">Never judge a decision by its outcome (Outcome Bias)</a></h2><p>A quick hypothesis: say one million monkeys speculate on the stock market. They
...
him the success monkey.</p><p>How does the media react? They will pounce on this animal to understand its
...
monkey? Impossible!</p><p>The monkey story illustrates the outcome bias: we tend to evaluate decisions
...
(particularly that it did indeed take place).</p><p>Another experiment: you must evaluate the performance of three heart
...
on the basis of the outcomes would be not only negligent but also unethical.</p><p>In conclusion: never judge a decision purely by its result, especially when randomness or ‘external factors’ play a role. A bad result does not automatically indicate a bad decision and vice versa. So rather than tearing your hair out about a wrong decision, or applauding yourself for one that may have only coincidentally led to success, remember why you chose what you did. Were your reasons rational and understandable? Then you would do well to stick with that method, even if you didn’t strike lucky last time.</p></section>`,1);function p(e){var t=s();i(18),o(e,t)}export{p as default,n as metadata};
