import{t as o,a}from"./DrjBu-Pq.js";import"./CeIxqNZp.js";import{$ as i}from"./CnMiI8Eq.js";const s={title:"The Art of Thinking Clearly (Part 3)",date:"2023-04-11",categories:["psychology"]},{title:d,date:c,categories:u}=s;var n=o(`<section><h2 id="less-is-more-the-paradox-of-choice"><a href="#less-is-more-the-paradox-of-choice">Less is more (The Paradox of Choice)</a></h2><p>I’ve counted and researched: my local grocery store stocks 48 varieties of
yogurt, 134 types of red wine, 64 different cleaning products and a grand total of
30,000 items. Amazon, the Internet bookseller, has two million titles available.</p><p>And yet, selection is the yardstick of progress. It is what sets us apart from
...
The technical term for this is the <strong>paradox of choice</strong>.</p><p>In his book of the same title, psychologist Barry Schwartz describes why this is
...
same.</p><p>Second, a broader selection leads to poorer decisions. If you ask young people
...
choose among maybe twenty girls of similar age with whom he went to school.</p><p>He knew their families and vice versa, leading to a decision based on several
...
single criterion: physical attractiveness.</p><p>The consequences of this selection process you already know – perhaps even from personal experience.
...
dissatisfied you are afterward.</p><p>So, what can you do? Think carefully about what you want before you inspect existing offers. Write down these criteria and stick to them rigidly. Also, realise that you can never make a perfect decision. Aiming for this, given the flood of possibilities, is a form of irrational perfectionism. Instead, learn to love a ‘good’
choice. Yes, even in terms of life partners. Only the best will do? In this age of unlimited variety, rather the opposite is true: ‘good enough’ is the new optimum(except, of course, for you and me).</p></section> <section><h2 id="you-like-me-you-really-really-like-me-liking-bias"><a href="#you-like-me-you-really-really-like-me-liking-bias">you like me, you really really like me (liking bias)</a></h2><p>Kevin has just bought two boxes of fine Margaux. He rarely drinks wine – not even Bordeaux – but the sales assistant was so nice, not fake or pushy, just really
likeable. So he bought them.</p><p>Joe Girard is considered the most successful car salesman in the world. His tip
...
each month. Just one sentence salutes them: ‘I like you.’</p><p>The liking bias is startlingly simple to understand and yet we continually fall
...
language, and facial expressions of his prospective client.</p><p>If the buyer speaks very slowly and quietly, often scratching his head, it makes sense for the seller to
speak slowly and quietly, and to scratch his head now and then too. That makes
him likeable in the eyes of the buyer, and thus a business deal is more likely.</p><p>Finally, it’s not unheard of for advertisers to pay us compliments: how many times
...
they ring hollow as a drum.</p><p>So-called multilevel marketing (selling through personal networks) works solely
...
the second and third congeniality standard perfectly.</p><p>Aid agencies employ the liking bias to great effect. Their campaigns use
...
is extinct? Too bad.</p><p>Politicians, too, are maestros of the liking bias. Depending on the make-up and
...
on the irrelevant.</p><p>A friend who deals in oil pumps told me how he once closed an eight-figure
...
bribery.’</p><p>So, if you are a salesperson, make buyers think you like them, even if this means outright flattery. And if you are a consumer, always judge a product independent of who is selling it. Banish the salespeople from your mind, or rather, pretend you don’t like them.</p></section> <section><h2 id="dont-cling-to-things-endowment-effect"><a href="#dont-cling-to-things-endowment-effect">Don’t cling to things (Endowment Effect)</a></h2><p>The BMW gleamed in the parking lot of the used-car dealership. Although it had a
...
we ourselves would be willing to spend.</p><p>To probe this, psychologist Dan Ariely conducted the following experiment: in
...
add zeros to the selling price.</p><p>In real estate, the endowment effect is palpable. Sellers become emotionally
...
absurd since this excess is little more than sentimental value.</p><p>We can safely say that we are better at collecting things than at casting them
...
Amazingly, the endowment effect affects not only possession but also nearownership.</p><p>Auction houses like Christie’s and Sotheby’s thrive on this. A person who bids until the end of an auction gets the feeling that the object is practically
...
successful bidder turns out to be the economic loser when he gets caught up in the fervour and overbids.</p><p>There’s a similar effect in the job market. If you are applying for a job and don’t
...
don’t; nothing else should matter.</p><p>In conclusion: don’t cling to things. Consider your property something that the
‘universe’ (whatever you believe this to be) has bestowed on you temporarily. Keep in mind that it can recoup this (or more) in the blink of an eye.</p></section> <section><h2 id="the-inevitability-of-unlikely-events-coincidence"><a href="#the-inevitability-of-unlikely-events-coincidence">THE INEVITABILITY OF UNLIKELY EVENTS: Coincidence</a></h2><p>At 7.15p.m. on 1 March 1950, the fifteen members of the church choir in Beatrice,
...
received a sign from God. Hand of God or coincidence?</p><p>Something last week made me think of my old school friend, Andy, whom I
...
telepathy or coincidence?</p><p>On 5 October 1990, the San Francisco Examiner reported that Intel would take
...
communicate with your worshippers!)</p><p>Let’s apply the same thinking to the phone call. Keep in mind the many
...
greatly.</p><p>We tend to stumble when estimating probabilities. If someone says ‘never’, I
usually register this as a minuscule probability greater than zero, since ‘never’
cannot be compensated by a negative probability.</p><p>In sum: let’s not get too excited. Improbable coincidences are precisely that:
rare but very possible events. It’s not surprising when they finally happen. What
would be more surprising would be if they never came to be.</p></section> <section><h2 id="the-calamity-of-conformity-groupthink"><a href="#the-calamity-of-conformity-groupthink">The Calamity of Conformity (Groupthink)</a></h2><p>Have you ever bitten your tongue in a meeting? Surely. You sit there, say nothing
...
might be the most important.</p></section> <section><h2 id="why-youll-soon-be-playing-megatrillions"><a href="#why-youll-soon-be-playing-megatrillions">Why you’ll soon be playing megatrillions</a></h2><p>Neglect of Probability
...
and one in 10,000 in the second game. So which do you choose?</p><p>Our emotions draw us to the first game, even though the second is ten times
...
Trillions – no matter how small the odds are.</p><p>In a classic experiment from 1972, participants were divided into two groups.
...
other words: we lack an intuitive grasp of probability.</p><p>The proper term for this is neglect of probability, and it leads to errors in
...
no natural feel for this so we often turn a blind eye to it.</p><p>Back to the experiment with the electric shocks: in group B, the probability of
...
from a biotech laboratory.</p><p>We have no intuitive grasp of risk and thus distinguish poorly between different
...
chemicals. An irrational response, but a common one.</p></section> <section><h2 id="scarcity-error"><a href="#scarcity-error">Scarcity Error</a></h2><p>Coffee at a friend’s house. We sat trying to make conversation while her three
...
of a kind. I had to laugh at how childish children are!</p><p>In August 2005, when I heard that Google would launch its own email service, I
...
have to laugh at how childish adults are!</p><p>Rara sunt cara, said the Romans. Rare is valuable. In fact, the scarcity error is
...
short supply.</p><p>In one study, students were asked to arrange ten posters in order of
...
teenagers – just because it’s illegal to drink below the age of 21.</p><p>In conclusion: the typical response to scarcity is a lapse in clear thinking.
...
London take an interest.</p></section> <section><h2 id="28-base-rate-neglect"><a href="#28-base-rate-neglect">28. Base-Rate Neglect</a></h2><p>Mark is a thin man from Germany with glasses who likes to listen to Mozart.
...
fall for it on a regular basis.</p><p>Here is a second example: a young man is stabbed and fatally injured. Which
...
middle-class Americans than there are Russian knife importers.</p><p>In medicine, base-rate neglect plays an important role. For example, migraines
...
diseases, even if you are a specialist in that.</p><p>Doctors are the only professionals who enjoy this base-rate training.
...
cases.</p><p>Imagine you are sampling wine in a restaurant and have to guess from which
...
Californian twist.</p><p>Sometimes I have the dubious honour of speaking in front of students of elite
...
future mid-life crises.</p></section> <section><h2 id="gamblers-fallacy"><a href="#gamblers-fallacy">Gambler’s Fallacy</a></h2><p>In the summer of 1913, something incredible happened in Monte Carlo. Crowds
...
bankrupt.</p><p>The average IQ of pupils in a big city is 100. To investigate this, you take a
...
of 101 in the sample.</p><p>The Monte Carlo example and the IQ experiment show that people believe in
...
victim of the gambler’s fallacy.</p><p>The following joke illustrates this phenomenon: a mathematician is afraid of
...
plane is virtually zero!’</p><p>A coin is flipped three times and lands on heads on each occasion. Suppose
...
to believe that something must change.</p><p>A coin is tossed 50 times, and each time it lands on heads. Again, with
someone forcing you to bet, do you pick heads or tails? Now that you’ve seen an
example or two, you’re wise to the game: you know that it could go either way.</p><p>But we’ve just come across another pitfall: the classic déformation
...
it stands out so much – a sort of reverse compensation effect.</p><p>So, take a closer look at the independent and interdependent events around
...
around’ simply does not exist.</p></section> <section><h2 id="the-anchor"><a href="#the-anchor">The Anchor</a></h2><p>When was Abraham Lincoln born? If you don’t know the year off the top of your
...
heads? That would be irrational.</p><p>Unfortunately, we also use anchors when we don’t need to. For example, one
...
hidden and misleading way.</p><p>The psychologist Amos Tversky conducted an experiment involving a wheel of
...
dropped: the price negotiations started at exactly five million</p></section>`,1);function p(e){var t=n();i(18),a(e,t)}export{p as default,s as metadata};
